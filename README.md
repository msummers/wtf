...
## Structure
### Landing page
- Menu bar/navigation/search
- Masthead
- Feed
  - Guest:
    - you get a mix of the site's blog + user blogs (if the user allows visibility)
  - Logged in:
    - Custom feed via subscribing to a user or subscribing to tags
- Side panel
  - Ads
  - Info